...
public class SimpleChatClient {
		...
		public void go() {
			...
			//membuat thread baru menggunakan class yg dibuat sebagai Runnable utk thread (IncomingReader)
			//thread bertugas untuk membaca pesan dari stream socket server, menampilkannya di text area client
