...
public class LandingPage extends JFrame {
    ...
    public LandingPage() {
        ...
        infoText.setFont(new Font("Roboto", Font.PLAIN, 14));
        ...
        paketLabel.setFont(new Font("Roboto", Font.PLAIN, 20));
        ...
        paketCardsPanel.setLayout(new GridLayout(1, 4, 15, 0));
        ...
        gameLabel.setFont(new Font("Roboto", Font.PLAIN, 20));
    ...
    private JPanel createPaketCard(String title, String fasilitasText) {
        ...
        fasilitasArea.setFont(new Font("Roboto", Font.PLAIN, 12));
    ...
    private JPanel createGameCard(String name, String genre, String imgPath) {
        JPanel panel = new JPanel();
        ...
        genreLabel.setFont(new Font("Roboto", Font.ITALIC, 10));
